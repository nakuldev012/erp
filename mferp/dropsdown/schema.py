...
class Query(graphene.ObjectType):
    all_master_configs = graphene.List(
        MasterConfigType, label=graphene.String(), id=graphene.Int()
    )
...
all_org_configs = graphene.List(
    OrgConfigType, org_name=graphene.String(), id=graphene.Int()
)
